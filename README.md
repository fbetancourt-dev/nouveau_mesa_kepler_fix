...
| `scripts/manage_drivers.sh` | Provides dual-driver ### 📺 Sample Terminal Audit Report Output (`audit_system_health.py`)
...
| **Chrome Video Decoding** | `--render-node-override=/dev/dri/by-path/pci-0000:00:02.0-render` | **`ACTIVE`** ✅ | Routes Chrome hardware video decoding to Intel Iris Pro iGPU, keeping dGPU VRAM load clean. |
